...
const goldChart = new CandleChart("gold-chart", { unit: "CNY/g", metal: "gold" }).setTitle("Au(T+D)");
const silverChart = new CandleChart("silver-chart", { unit: "CNY/kg", metal: "silver" }).setTitle("Ag(T+D)");
